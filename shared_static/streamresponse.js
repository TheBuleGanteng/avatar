...
import { jsScrollDown } from './utils.js';
import { jsFavoriteIconMonitor } from './favorites.js'

document.addEventListener('DOMContentLoaded', function() {
    console.log(`running streamresponse.js ... DOM content loaded`);
    console.log(`running streamresponse.js ... current origin is: ${ window.location.origin }`);
    ...
    function jsStreamResponse(form) {
        console.log(`running streamresponse.js ... function started`);
        ...
        // Logs
        console.log(`running streamresponse.js ... before appending to formData userInput is: ${userInput}`);
        console.log(`running streamresponse.js ... before appending to formData first_name is: ${first_name}`);
        console.log(`running streamresponse.js ... before appending to formData timestamp is: ${timestamp}`);
        
        // Log each key-value pair in the formData to ensure correctness
        for (var pair of formData.entries()) {
            console.log(`running streamresponse.js ... after appending to formData: ${ pair[0] + ': ' + pair[1] }`);
        }
        console.log(`running streamresponse.js ... all settings data appended to formData`);
        ...
        .then(data => {
            ...
            if (data.stream_id) {
                ...
                console.log(`running streamresponse.js ... EventSource URL: /aichat/stream_response/?stream_id=${data.stream_id}`);
                ...
                eventSource.onmessage = function (event) {
                    //console.log(`running streamresponse.js ... received event with ID: ${event.lastEventId || 'no id'}, data: ${event.data}`);
                    
                    // Log all properties of the event object
                    //console.log(`running streamresponse.js ... event properties:', event);

                    // Event ID
                    //console.log(`running streamresponse.js ... event ID directly accessed: ${event.id}`);
                    ...
                    if (event.data === "[BEGIN]") {
                        ...
                        console.log(`running streamresponse.js ... expert data is ${ expertData }`);
                        ...
                        expertCardParentDiv.setAttribute('class', 'card col-12 col-lg-6 col-xl-4 mt-2 mb-2 p-1');
                        ...
                        console.log(`running streamresponse.js ... Appended expert photo`);
                        ...
                        console.log(`running streamresponse.js ... streaming completed`);
                            jsScrollDown();
                            jsFavoriteIconMonitor();
                            
                            // Close the EventSource
                            eventSource.close();
                            console.log(`running streamresponse.js ... EventSource closed successfully after receiving [END] message.`);
