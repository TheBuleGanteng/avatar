...
document.addEventListener('DOMContentLoaded', function() {
    console.log(`running avatar.js ... DOM content loaded`);
    console.log(`running avatar.js ... current origin is: ${ window.location.origin }`);
    ...
    if (btnShowSettings) {
        btnShowSettings.addEventListener('click', function () {
            console.log(`running avatar.js ... sidebar settings button click detected`)

            const smScreenSideBarContracted = sidebarCollapsableDiv.classList.contains('d-none');
            
            if (smScreenSideBarContracted) {
                console.log(`running avatar.js ... showing sidebar`)
                // Expand the side bar
                ...
                console.log(`running avatar.js ... hiding sidebar`)
                // Shrink the sidebar
